...
export const TEXT_INFORMATION = [
    "Carica i dati del team, definisci il job profile, aggiungi i CV dei candidati e lascia che l'AI analizzi ogni profilo fornendo valutazioni oggettive su Job Fit, Team Fit e raccomandazioni finali.",
